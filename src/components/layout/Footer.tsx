        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <Link to="/" className="flex items-center gap-2">
              <div className="flex flex-col items-start justify-center">
                <div className="flex items-center gap-3 mb-2">
                  <img src="/ccib38_logo.png" alt="Logo CCIB38" className="w-12 h-12 object-contain rounded-lg" />
                  <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/rejoignez-nous" className="text-slate-500 hover:text-emerald-700 transition-colors text-sm font-medium">Rejoignez-nous / Recrutement</Link></li>
